...
root = Tk()
root.title('System and Hardware Info by AKASH')
...
Button(root, text='System Info', bg='#f2bc94', fg='#00154f', font='Verdana 10 bold', width=10,
       command=SystemInfo).place(x=20, y=100)
Button(root, text='Boot Time', bg='#f2bc94', fg='#00154f', font='Verdana 10 bold', width=10,
       command=boottime).place(x=140, y=100)
Button(root, text='CPU Info', bg='#f2bc94', fg='#00154f', font='Verdana 10 bold', width=10,
       command=CPUInfo).place(x=260, y=100)
Button(root, text='Memory Info', bg='#f2bc94', fg='#00154f', font='Verdana 10 bold', width=10,
       command=MemoryInfo).place(x=380, y=100)
Button(root, text='Disk Info', bg='#f2bc94', fg='#00154f', font='Verdana 10 bold', width=10,
       command=DiskInfo).place(x=500, y=100)
Button(root, text='Network Info', bg='#f2bc94', fg='#00154f', font='Verdana 10 bold', width=10,
       command=NetworkInfo).place(x=20, y=160)
Button(root, text='Graphic Info', bg='#f2bc94', fg='#00154f', font='Verdana 10 bold', width=10,
       command=GPUInfo).place(x=20, y=220)
Button(root, text='Follow', bg='#f2bc94', fg='#00154f', font='Verdana 10 bold', width=10,
       command=Followme).place(x=20, y=280)
